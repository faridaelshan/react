  ...
  return (
      <div className='d-flex flex-column'>
          <div className='d-flex justify-content-around mt-2'>
             ...
             <div>
                 <button className='btn btn-white'><AiOutlineHeart style={{fontSize: "25"}}/></button>
                 <button className='btn btn-white'><FaSearch style={{fontSize: "25"}}/></button>
                 <button className='btn btn-white'> <Link style={{"color":"black"}} to="/cart"><BsFillBasket2Fill style={{fontSize: "25"}}/></Link></button>
             </div>
          </div>
          <div className='d-flex justify-content-center'>
